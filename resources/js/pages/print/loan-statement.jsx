                ...
                <div className="mx-auto max-w-5xl rounded-3xl bg-white p-6 shadow-sm print:max-w-none print:rounded-none print:p-8 print:shadow-none">
                    ...
                    <div className="mt-6 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                        {[
                            ...
                            [t('customers.totalPaid'), loan.total_paid_money || money(loan.total_paid, locale)],
                            [t('customers.remainingBalance'), loan.remaining_balance_money || money(loan.remaining_balance, locale)],
                            [t('customers.overdueAmount'), loan.overdue_amount_money || money(0, locale)],
